			...
			<form id="edit-profile" class="form-horizontal">
				<fieldset>
					...
					<div class="control-group">											
						<label class="control-label" for="text">txt</label>
						<div class="controls">
							<input type="text" class="span6" id="text" value="thisistext">
						</div> <!-- /controls -->				
					</div> <!-- /control-group -->
					
					
					<div class="control-group">											
						<label class="control-label" for="password2">passs</label>
						<div class="controls">
							<input type="password" class="span6" id="password2" value="thisispassword">
						</div> <!-- /controls -->				
					</div> <!-- /control-group -->
