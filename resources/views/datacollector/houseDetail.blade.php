			...
			<form id="add-profile" class="form-horizontal" action="{{ route('housedetail.store') }}" method="POST">
				...
				<fieldset>
					...
					<div class="control-group">											
						...
						<div class="controls">
							<input type="text" class="span9" name="area" id="area" value="{{ isset($data->area)?$data->area:old('area') }}" required>						
							@if($errors->has('area'))<p class="red">{{$errors->first('area')}}</p>@endif	
						</div> <!-- /controls -->
					...
					<div class="control-group">											
						...
						<div class="controls">
							<input type="text" class="span9" name="storey_count" id="lastname" value="{{ isset($data->storey_count)?$data->storey_count:old('storey_count') }}" required>
							@if($errors->has('storey_count'))<p class="red">{{$errors->first('storey_count')}}</p>@endif
						</div> <!-- /controls -->				
					</div> <!-- /control-group -->
					...
					<span class="hidden-form" id="disablitiy-form"> 
						<div class="control-group">											
							...
							<div class="controls">
								<input type="text" class="span9" name="rented_room_count" id="fname" value="{{  isset($data->rented_room_count)?$data->rented_room_count:old('rented_room_count') }}" >
								@if($errors->has('rented_room_count'))<p class="red">{{$errors->first('rented_room_count')}}</p>@endif
							</div> <!-- /controls -->				
						</div> <!-- /control-group -->
						...
						<div class="control-group">											
							...
							<div class="controls">
								<input type="text" class="span9" name="rented_person_count" id="mname" value="{{  isset($data->rented_person_count)?$data->rented_person_count:old('rented_person_count') }}" >
								@if($errors->has('rented_person_count'))<p class="red">{{$errors->first('rented_person_count')}}</p>@endif
							</div> <!-- /controls -->				
						</div> <!-- /control-group -->
						...
						<div class="control-group">											
							...
							<div class="controls">
								<input type="text" class="span9" name="monthly_rent" id="gname" value="{{  isset($data->monthly_rent)?$data->monthly_rent:old('monthly_rent') }}" >
								@if($errors->has('monthly_rent'))<p class="red">{{$errors->first('monthly_rent')}}</p>@endif
							</div> <!-- /controls -->				
						</div> <!-- /control-group -->
					</span>
