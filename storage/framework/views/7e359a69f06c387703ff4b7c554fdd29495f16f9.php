...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('css/c.css')); ?>">
</head>
<body>
...
<div class="container-fluid">
  <div class="hearde">
    <div class="row">
  <div class="col-sm-1">
  <img src="<?php echo e(asset('images/logo.png')); ?>" width="100px"></div>
  <div class="col-sm-11">
  <h2>नेपाल सरकार<br>
...
<li><a href="#"><i class="fab fa-accessible-icon "> </i> फरक क्षमता</a></li>
  ...
  <div class="body">
    <div class="row">
  <div class="col-sm-6">
<img src="<?php echo e(asset('images/Screenshot_2019-04-29%20LG-PROFILE%20MoFALD.png')); ?>" width="100%"><br><br>
<img src="<?php echo e(asset('images/Screenshot_2019-04-29%20LG-PROFILE%20MoFALD(2).png')); ?>" width="100%">
</div>
  <div class="col-sm-6">
<img src="<?php echo e(asset('images/Screenshot_2019-04-29%20LG-PROFILE%20MoFALD(1).png')); ?>" width="100%"><br><br>
<img src="<?php echo e(asset('images/Screenshot_2019-04-29%20LG-PROFILE%20MoFALD(3).png')); ?>" width="100%">
  </div>
</div> 
  </div>
  <!-- <div class="foots">
